    ...
    <div class="container">
            <div class="row"> 
                ...
                <div class="col dashboard-content">
                    ...
                    <form class="edit-form" action="{{ route('tutor.personalinfoupdate') }}"  method="POST">
                        @csrf
                        @include('elements.user.alert_message')
                        <div class="row">
                            <div class="col-md-6 form-field">
                                <label class="form-label" for="account-type">Account Type</label>
                                <input type="text" class="form-control" id="account-type" value="Tutor" readonly="" disabled="">
                            </div>
                            <div class="col-md-6 form-field">
                                ...
                                <div class="select-field">
                                    <select class="form-select" id="name-title" name="title">
                                        ...
                                        <option value="Mr"  {{ $personalinfo->tutor->title == 'Mr' ? 'selected' : '' }}>Mr</option>
                                        <option value="Miss" {{ $personalinfo->tutor->title == 'Miss' ? 'selected' : '' }}>Miss</option>
                                        <option value="Mrs" {{ $personalinfo->tutor->title == 'Mrs' ? 'selected' : '' }}>Mrs</option>
                                        <option value="Ms" {{ $personalinfo->tutor->title == 'Ms' ? 'selected' : '' }}>Ms</option>
                                    </select>
                                    <svg>
                            ...
                            <div class="col-md-6 form-field">
                                ...
                                <input class="form-control" name="town" type="text" id="town" name="town" placeholder="Town" value="{{ old('town', $personalinfo->tutor->town ?? '') }}" required="">
                            </div>
                            <div class="col-md-6 form-field">
                                ...
                                <div class="select-field">
                                    <select class="form-select" id="county" name="county">
                                        ...
                                        <option value="{{$id}}" {{ $personalinfo->tutor->county == $id ? 'selected' : '' }}>{{ $name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="select-field">
                                    <select class="form-select" id="country" name="country" disabled="">
                                        ...
                                        @foreach($countries as $id => $name)
                                            <option value="{{$id}}" {{ $personalinfo->tutor->country == $id ? 'selected' : '' }}>{{ $name }}</option>
                                        @endforeach
                                    </select>
