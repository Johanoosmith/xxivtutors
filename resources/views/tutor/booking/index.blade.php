			...
			<div class="col dashboard-content">
				...
				<form action="{{ route('tutor.booking.index') }}" method="GET" id="filter-form">
					<div class="row mb-4">
						...
						<div class="col-md-3 gap-1 d-flex fiter-btn-pd">
							<button type="submit" class="btn btn-sm custom_btn btn-primary filter-btn d-flex align-items-center justify-content-center">
							...
							<a href="{{ route('tutor.booking.index') }}" class="btn btn-dark btn-sm reset-btn d-flex align-items-center justify-content-center">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
									stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
