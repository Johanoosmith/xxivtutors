                ...
                <div class="tutor-profile">
                    ...
                    <div class="member-info" style="margin-left:50px">
                        <div class="tutoe-meta">
                            <div class="repeat"><span>{{ @$tutor->qualification_1 ?? "NA"}}</span></div>
                            <div class="hours"><span>{{ @$tutor->qualification_2  ?? "NA" }}</span></div>
                            <div class="travels"><span>{{ @$tutor->qualification_3  ?? "NA"}}</span></div>
                            <div class="response"><span>{{ @$tutor->qualification_4  ?? "NA" }}</span></div>
                            <div class="member"><span>{{ @$tutor->experience  ?? "NA" }}</span></div>
                        </div>
                    </div>
                    @php
