        ...
        <div class="row">
            <div class="col col-tutor-info">
                <div class="tutor-profile">
                    ...
                    @if(!empty($tutor->qualification_1) || !empty($tutor->qualification_2) || !empty($tutor->qualification_3) || !empty($tutor->qualification_4) || !empty($tutor->experience))

                    <p><strong>My Qualifications</strong></p>
                    <div class="member-info" style="margin-left:50px">
                        <div class="tutoe-meta">
                            @if(!empty($tutor->qualification_1))
                            <div class="repeat"><span>{{ @$tutor->qualification_1 ?? ""}}</span></div>
                            @endif
                            @if(!empty($tutor->qualification_2) )
                            <div class="hours"><span>{{ @$tutor->qualification_2  ?? "" }}</span></div>
                            @endif
                            @if(!empty($tutor->qualification_3) )
                            <div class="travels"><span>{{ @$tutor->qualification_3  ?? ""}}</span></div>
                            @endif
                            @if(!empty($tutor->qualification_4) )
                    ...
                    <div class="student-editprofile">
                        <a href="{{ route('tutor.personalinfo')}}" class="user-btn mt-3">
                            Edit Your Profile
                    ...
                    <div class="student-updatepro">
                        <a href="{{ route('tutor.photo.upload')}}" class="user-btn">
            ...
            <div class="col col-tutor-description">
                ...
                @if(!empty($inPlaceSubjects['subjects']) || !empty($onlineSubjects['subjects']))
                <h5>Subjects</h5>
                <br>
