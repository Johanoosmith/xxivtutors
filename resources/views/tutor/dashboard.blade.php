                    ...
                    <div class="col dashboard-content">
                        @if (request('tab') == 'profile')
                            ...
                            <div class="profile-tabs">
                                <ul>
                                    <li class="{{ Request::routeIs('tutor.profile.view') ? 'active' : '' }}"><a
                                            href="{{ route('tutor.profile.view') }}">Edit Profile</a></li>
                                    <li class="{{ Request::routeIs('tutor.qualification') ? 'active' : '' }}"><a
                                            href="{{ route('tutor.qualification') }}">Qualifications</a></li>
                                    <li class="{{ Request::routeIs('tutor.myavailability') ? 'active' : '' }}"><a
                                            href="{{ route('tutor.myavailability') }}">My Availability</a></li>
                                    <li class="{{ Request::routeIs('tutor.headlines') ? 'active' : '' }}"><a
                                            href="{{ route('tutor.headlines') }}">Headlines</a></li>
                                    <li class="{{ Request::routeIs('tutor.foundme') ? 'active' : '' }}"><a
                                            href="{{ route('tutor.foundme') }}">Who's Found Me?</a></li>
                                </ul>
                            </div>
                            <form method="POST" action="{{ route('tutor.profile.view.update', $user->id) }}"
                                name="signupform" id="signupform" class="edit-form">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <p>Please complete the following information to help us build your profile so
                                            students can learn more about you.</p>
                                    </div>
                                    ...
                                    <div class="col-12 form-field">
                                        ...
                                        <textarea class="form-control" rows="30" cols="11" id="comments" maxlength="6500" name="short_description"
                                    ...
                                    <div class="col-12 form-field">
                                        <label class="form-label" for="edit-availability">To help us promote your profile to
                                            online students, tell us about your online teaching experience</label>
                                    ...
                                    <div class="col-md-6 form-field">
                                        ...
                                        <div class="select-field">
                                            ...
                                            @php
                                                $selectedLanguages = $tutor->language
                                                    ? explode(',', $tutor->language)
                                                    : [];
                                            @endphp

                                            <select class="form-select select2" id="language" name="language[]" multiple>
                                                @foreach ($languages as $lang_id => $lang_name)
                                                    <option value="{{ $lang_id }}"
                                                        {{ in_array((string) $lang_id, $selectedLanguages) ? 'selected' : '' }}>
                                                        {{ $lang_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6 form-field">
                                        ...
                                        <div class="select-field">
                                            <select name="distance" id="distance" class="form-select">
                                                @foreach ([0 => 'Home Only', 1 => '1 mile', 2 => '2 miles', 3 => '3 miles', 4 => '4 miles', 5 => '5 miles', 8 => '8 miles', 10 => '10 miles', 12 => '12 miles', 15 => '15 miles', 20 => '20 miles', 30 => '30 miles', 50 => '50 miles'] as $key => $value)
                                                    <option value="{{ $key }}"
                                    ...
                                    <div class="col-md-4">
                                        <h4>Your Profile is
                                            <span id="status-label"
                                                class="{{ auth()->user()->is_online ? 'text-success' : 'text-danger' }}">
                                                {{ auth()->user()->is_online ? 'Online' : 'Offline' }}
                                            </span>
                                        </h4>
                                        <p><a href="" id="toggle-status-link">Switch
                                                {{ auth()->user()->is_online ? 'Offline' : 'Online' }}</a></p>
                                    </div>
                                    <div class="col-md-4">
                                        <h4>Your Profile Link:</h4>
                                        <p>
                                            <a href="{{ route('tutor', ['id' => $user->id]) }}" class="text-truncate"
                                                target="_blank">
