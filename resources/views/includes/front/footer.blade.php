            ...
            <div class="col-lg-7">
                <form class="newsletter-form" action="{{ route('subscribe.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="field">
                                <input type="text" id="name" class="input" placeholder="First Name" value="{{ old('s_name') }}" name="s_name" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="field">
                                <input type="email" class="input" placeholder="Email" value="" name="s_email" id="email" required>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="field select-field">
                                <select class="select" id="role" name="s_role">
                                    <option>Who are you</option>
                                    <option value="tutor" {{ old('s_role') == 'tutor' ? 'selected' : '' }}>Tutor</option>
                                    <option value="student" {{ old('s_role') == 'student' ? 'selected' : '' }}>Student</option>
                                </select>
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <ul class="footer-links">
                    <li><a href="{{ route('tutors.tutorFilter', ['subject' => 'maths']) }}">Maths</a></li>
                    <li><a href="{{ route('tutors.tutorFilter', ['subject' => 'science']) }}">Science</a></li>
                    <li><a href="{{ route('tutors.tutorFilter', ['subject' => 'english']) }}">English</a></li>
                    <li><a href="{{ route('tutors.tutorFilter', ['subject' => 'history']) }}">History</a></li>
                    <li><a href="{{ route('tutors.tutorFilter', ['subject' => 'biology']) }}">Biology</a></li>
                    <li><a href="{{ route('tutors.tutorFilter', ['subject' => 'geography']) }}">Geography</a></li>
                    <li><a href="{{ route('tutors.tutorFilter', ['subject' => 'chemistry']) }}">Chemistry</a></li>
                    <li><a href="{{ route('tutors.tutorFilter', ['subject' => 'physics']) }}">Physics</a></li>
                </ul>
            </div>
            ...
            <div class="col-lg-3">
                ...
                <ul class="footer-links">
                    <li><a href="{{ route('tutors.tutorFilter', ['town' => 'london']) }}">London</a></li>
                    <li><a href="{{ route('tutors.tutorFilter', ['town' => 'leeds']) }}">Leeds</a></li>
                    <li><a href="{{ route('tutors.tutorFilter', ['town' => 'birmingham']) }}">Birmingham</a></li>
                    <li><a href="{{ route('tutors.tutorFilter', ['town' => 'manchester']) }}">Manchester</a></li>
                    <li><a href="{{ route('tutors.tutorFilter', ['town' => 'glasgow']) }}">Glasgow</a></li>
                    <li><a href="{{ route('tutors.tutorFilter', ['town' => 'bradford']) }}">Bradford</a></li>
                    <li><a href="{{ route('tutors.tutorFilter', ['town' => 'liverpool']) }}">Liverpool</a></li>
                    <li><a href="{{ route('tutors.tutorFilter', ['town' => 'bristol']) }}">Bristol</a></li>
                    <li><a href="{{ route('tutors.tutorFilter', ['town' => 'sheffield']) }}">Sheffield</a></li>
                    <li><a href="{{ route('tutors.tutorFilter', ['town' => 'coventry']) }}">Coventry</a></li>
                    <li><a href="{{ route('tutors.tutorFilter', ['town' => 'edinburgh']) }}">Edinburgh</a></li>
                </ul>
            </div>
