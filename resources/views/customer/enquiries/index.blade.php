                                        ...
                                        <td> 
                                            <div class="infopanel-wrapper">
                                                <span style="position: relative; top: -2px; ">
                                                    <a href="{{ route('student.enquiries.chat', $enquiry->id) }}">
                                        ...
                                        <td>
                                            <div class="menuholder dropdown">
                                                ...
                                                <div class="dropdownmenu">
                                                    <a href="{{ route('student.enquiries.chat', $enquiry->id) }}">View Enquiry</a>
                                                    <a href="{{ route('customer.booking.index') }}">View Lessons</a>
                                                    ...
                                                    @if($enquiry->status == 1)
                                                        ...
                                                        <form id="{{ 'EnquiryClose_'.$enquiry->id }}" action="{{ route('student.enquiries.close', $enquiry->id) }}" method="POST" style="display: inline;" data-toggle="tooltip"  title="" data-original-title="Close Enquiry" >
                                                            @csrf
                                                            @method('POST')
                                                        </form>
                                                        ...
                                                        <a href="{{ route('student.enquiries.report', $enquiry->id) }}">Report Enquiry</a>
                                                    @endif
