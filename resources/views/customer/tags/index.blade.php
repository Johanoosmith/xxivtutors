                                    ...
                                    <tbody>
                                        ...
                                        @foreach($tags as $tag)
                                            <tr>  
                                                ...
                                                <form id="{{ 'TagDelete_'.$tag->id }}" action="{{ route('customer.tag.delete', $tag->id) }}" method="POST" style="display: inline;" data-toggle="tooltip" onsubmit="return confirm('are you sure to delete record?');" title="Delete Tag" data-original-title="Delete Tag" >
													@csrf
													@method('POST')
