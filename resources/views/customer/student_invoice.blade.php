            ...
            <div class="col dashboard-content">
                <div class="invoice-container">
                    <div class="title-with-link-wrapper">
                        ...
                        <a href="{{ route('invoice.download', $payment->id) }}" class="btn btn-yellow btn-small">Print</a>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h5>Tutor </h5>
                            <p class="m-0">{{ config('constants.SITE.TITLE') }}:</p>
                            <p class="m-0">{{ config('constants.SITE.ADDRESS') }}</p>
