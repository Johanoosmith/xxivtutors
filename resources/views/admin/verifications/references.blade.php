                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    foreach ($reference->references as $ref) {
                                    if ($ref->status === 'approved') {
                                    $approvedCount++;
                                    } elseif ($ref->status === 'reject' || $ref->status === 'cancelled') {
                                    $rejectedCount++;
                                    ...
                                    if ($approvedCount > $rejectedCount && $approvedCount > $pendingCount) {
                                    $status = 'approved';
                                    $badgeClass = 'success';
                                    } elseif ($rejectedCount > $approvedCount && $rejectedCount > $pendingCount) {
                                    $status = 'rejected';
                                    $badgeClass = 'danger';
                                    }
                                    @endphp
