...
<div class="form-group row">
    <div class="col-sm-4">
        ...
        <select name="status" id="status" class="form-control">
            <option value="1" {{ old('status', $tutor->tutor->users->status ?? '') == 1 ? 'selected' : '' }}>Active</option>
            <option value="0" {{ old('status', $tutor->tutor->users->status ?? '') == 0 ? 'selected' : '' }}>Inactive</option>
        </select>
    </div>
</div>
<div class="form-group row">
