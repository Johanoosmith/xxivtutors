			...
			<div class="card">
				<div class="card-header">
					<div class="row">
						...
						<div class="col-md-2">
							<a href="{{ route('admin.tutors.create') }}" class="btn btn-primary btn-sm custom_btn float-right"><i class="fa fa-plus" aria-hidden="true"></i>
                            Add New</a>
						</div>
					</div>
				</div>
                ...
                <div class="card-body table-border-style mb-2">
                    ...
                    <form action="{{ route('admin.tutors.index') }}" method="GET" id="filter-form">
                        <div class="row mb-4">
                            <div class="col-md-4">
                               <input type="text" name="fullname" class="form-control" placeholder="Search by Full Name & Email" value="{{ request()->fullname }}">
                            </div>
                            <div class="col-md-3">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @elseif($tutor->status == 0)
                            <label class="badge bg-light-warning">{{ ucfirst('inactive') }}</label>  <!-- Yellow badge for inactive status -->
                        @else
                            <label class="badge bg-light-warning">{{ ucfirst('unknown') }}</label>  <!-- Yellow badge for any other status -->
                        @endif
                    </td>
                    <td class="noselect text-right">
                    <div class="action-tools">
						<a href="{{ route('admin.tutors.edit', $tutor->id) }}" class="btn btn-info btn-sm action-btn edit" data-toggle="tooltip" title="" data-original-title="Edit">
							<i class="far fa-edit"> Edit</i>
						</a>
                        <a href="{{ Route('admin.delete-tutors', $tutor->id ) }}" onclick="confirmation(event)" class="btn btn-danger btn-sm action-btn delete" data-toggle="tooltip" title="Delete">
