                ...
                <tr>
                    ...
                    <td class="noselect text-right">	
                                <div class="action-tools">
                                    <a href="{{ route('admin.contact-us.destroy', $contact->id) }}" onclick="confirmation(event)" class="btn btn-danger btn-sm action-btn delete" data-toggle="tooltip" title="Delete">
