                ...
                <form action="{{ route('admin.cities.index') }}" method="GET" id="filter-form">
                    <div class="row mb-4">
                        ...
                        <div class="col-md-3 fiter-btn-pd">
                            ...
                            <a href="{{ route('admin.cities.index') }}" class="btn btn-dark btn-sm reset-btn">
                                ...
                                <td class="noselect text-right">
                                    <div class="action-tools">
                                        ...
                                        <form action="{{ route('admin.cities.destroy', $city->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this city?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger btn-sm action-btn delete" data-toggle="tooltip" title="Delete">
