<div class="row">
    ...
    <div class="col-md-6 form-field">
        <label class="form-label" for="distance">Distance Willing to Travel <span class="required text-danger">*</span>
        </label>
        <div class="select-field">
            <select class="form-select" id="distance" name="distance">
                <option value="" selected="selected">Select</option>
                <option value="0" {{ old('distance') == '0' ? 'selected' : '' }}>Home Only</option>
                <option value="1" {{ old('distance') == '1' ? 'selected' : '' }}>1 mile</option>
                <option value="2" {{ old('distance') == '2' ? 'selected' : '' }}>2 miles</option>
                <option value="3" {{ old('distance') == '3' ? 'selected' : '' }}>3 miles</option>
                <option value="4" {{ old('distance') == '4' ? 'selected' : '' }}>4 miles</option>
                <option value="5" {{ old('distance') == '5' ? 'selected' : '' }}>5 miles</option>
                <option value="8" {{ old('distance') == '8' ? 'selected' : '' }}>8 miles</option>
                <option value="10" {{ old('distance') == '10' ? 'selected' : '' }}>10 miles</option>
                <option value="12" {{ old('distance') == '12' ? 'selected' : '' }}>12 miles</option>
                <option value="15" {{ old('distance') == '15' ? 'selected' : '' }}>15 miles</option>
                <option value="20" {{ old('distance') == '20' ? 'selected' : '' }}>20 miles</option>
                <option value="30" {{ old('distance') == '30' ? 'selected' : '' }}>30 miles</option>
                <option value="50" {{ old('distance') == '50' ? 'selected' : '' }}>50 miles</option>
            </select>
    ...
    <div class="col-md-6 form-field">
        <label class="form-label" for="language">Your Native Language <span class="required text-danger">*</span>
        </label>
        <div class="select-field">
            ...
            <select class="form-select select2-multiple" id="language" name="language[]" multiple>
    ...
    <div class="col-12 step-submit">
        ...
        <button type="submit" onclick="nextStep()" class="btn btn-green">Submit</button>
    </div>
    @section('inline-js')
        <script>
