<?php
	...
	Route::group(['middleware' => ['admin']], function () {
        ...
        Route::delete('contact-us/{id}', 'App\Http\Controllers\Admin\ContactUsController@destroy')->name('admin.contact-us.destroy');
		//Route::resource('contact-us/{id}', 'App\Http\Controllers\Admin\ContactUsController')->except(['show']);
